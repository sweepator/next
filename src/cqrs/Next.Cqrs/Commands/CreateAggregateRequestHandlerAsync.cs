...
{
    public abstract class CreateAggregateRequestHandlerAsync<TAggregate, TIdentity, TState, TCommand, TCommandResponse> : CommandHandler<TCommand, TCommandResponse>
        ...
        where TCommandResponse : CommandResponse, new()
    {
        ...
        protected CreateAggregateRequestHandlerAsync(IAggregateRepository<TAggregate, TIdentity, TState> aggregateRepository)
        {
